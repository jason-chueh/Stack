...
class HomeCarouselAdapter :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            VIEW_TYPE_EVEN -> {
                val binding = ItemCarouselEvenBinding.inflate(layoutInflater, parent, false)
                WorkoutViewHolderEven(binding)
            }
            VIEW_TYPE_ODD -> {
                val binding = ItemCarouselOddBinding.inflate(layoutInflater, parent, false)
    ...
    inner class WorkoutViewHolderOdd(private val binding: ItemCarouselOddBinding) :
    ...
    inner class WorkoutViewHolderEven(private val binding: ItemCarouselEvenBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(workout: Workout) {
            binding.templateTitleText.text = workout.workoutName
            binding.dateText.text = formatTimestampToMonthDay(workout.startTime)
